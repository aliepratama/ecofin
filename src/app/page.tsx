        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 text-left border-t border-border pt-16">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Tinggal jepret bon belanja dari supplier, sistem akan mengenali
              otomatis apakah ini Pemasukan atau Pengeluaran.
            </p>
          </div>
          <div className="space-y-3">
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-foreground text-background">
            ...
            <p className="text-muted-foreground">
              Sedang sibuk melayani pelanggan? Cukup ucapkan "Hari ini laku 5
              porsi ayam geprek total 100 ribu".
            </p>
          </div>
          <div className="space-y-3">
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-foreground text-background">
            ...
            <p className="text-muted-foreground">
              Pahami kesehatan bisnis toko Anda. Lihat laporan transparan agar
              tak ada lagi uang yang "hilang" misterius.
            </p>
          </div>
        </div>
      </div>
